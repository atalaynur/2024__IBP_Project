...
<body>
    <div class="reservation-form">
        ...
        <form id="reserveForm" action="" method="POST">
            ...
            <div class="form-group">
                <label for="reservationType">Psikologlar</label>
                <select id="reservationType" name="extremesports" required>
                    <option value="">Please Select</option>
                    <option value="Bungee Jumping">Prof. Dr. İsmail AKBAŞ</option>
                    <option value="Sky Diving">Dr. Sudenur GÜMÜŞ</option>
                    <option value="Surfing">Dr. İrem Nur YILDIZ</option>
                    <option value="Paragliding">Dr. Selin GÜLÇİÇEK</option>
                    <option value="Paragliding">Dr. Avni FERAH</option>
                </select>
            </div>
            <div class="form-group">
